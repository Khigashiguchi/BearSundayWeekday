<?php
namespace Khigashiguchi\BearSundayWeekday\Resource\Page;
...
class IndexTest extends TestCase
{
    ...
    {
        $this->resource = (new AppInjector('Khigashiguchi\BearSundayWeekday', 'app'))->getInstance(ResourceInterface::class);
    }
